...
A backend alkalmazás esetében a root könyvtárban szükséges kiadni az parancsot:
$mvn clean package
Ezt követően a target mappába legenerálódik a .jar file. Ezt a file-t szükséges a gyökérkönyvtárba mozgatni, majd elindítani a következő paranccsal: 
